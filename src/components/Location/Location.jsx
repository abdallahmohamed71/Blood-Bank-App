...
export default function Location() {
  ...
  const [loading, setLoading] = useState(false);
    function handelEnail(data){
        ...
        axios.post('http://localhost:3002/Email',data, {
          headers:{
  ...
  >
            <Form   id="contact-form">
                                ...
                                <div className="form-group">
                                    <Field type="text" className="form-control" id="user_name" name="name" placeholder="Name"  />
                                ...
                                <div className="form-group">
                                    <Field type="text" className="form-control" id="subject" name="subject" placeholder="Subject"  />
                                    <span className="text-danger"><ErrorMessage name="subject" /> </span>
                                </div>

                                <div className="form-group">
                                    <Field as="textarea"  className="form-control" rows="5" name="message" id="email_message" placeholder="Message" ></Field>
                                    <span className="text-danger"><ErrorMessage name="message" /> </span>
                                </div>

                                <div className="form-group">
                                    <Button type="submit" className="btn btn_theme">Send Now{loading && 
                                    Swal.fire({
                                      position: "top-end",
                                      icon: "success",
                                     title:"done",
