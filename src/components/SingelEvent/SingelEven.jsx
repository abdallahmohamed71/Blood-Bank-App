 ...
 return (
    ...
    <div className="col-12 bg_Allcampaings">
      <div className='container'>
          <div className="row">
              ...
              <p><a  onClick={HandelNavHome}>HOME</a>  / <a  onClick={HandelAllCamp}>ALL CAMPAIGNS</a>/ <a  > SINGLE EVENT</a></p>
              </div>
          </div>
      </div>    
       </div>
    ...
    <article class="post single-post-inner">
        ...
        <div class="single-post-inner-title">
            <h2>{camp.title}</h2>
            <p class="single-post-meta"><FontAwesomeIcon icon={faUser} /> {camp.name}   <FontAwesomeIcon icon={faShare} /> {camp.ditls}</p>
        </div>
